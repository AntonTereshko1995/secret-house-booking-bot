...
# Import from src since we're reusing the secret manager service
from backend.services.secret_manager_service import SecretManagerService
...
if "secrets-production" in os.environ:
    ...
    BACKEND_API_KEY = secret_manager_service.get_secret("BACKEND_API_KEY")
else:
