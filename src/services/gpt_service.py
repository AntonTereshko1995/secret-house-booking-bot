    ...
    async def generate_response(self, message: str) -> str:
        ...
        while retries > 0:
            try:
                ...
                LoggerService.warning(__name__, "generate_response", "Chat GPT Timeout Error. Try again.")
                retries -= 1
                if retries == 0:
                    LoggerService.error(__name__, "generate_response", "Chat GPT Timeout Error")
